...
- Sometimes we can easily sort hashmap values, through priority queue, or through bucket sort if we want keys together with values (eg: when count frequencies, use hash map or array, ie: bucket[frequency] = list<elements> where frequency is 0 to n)
